...
<?php
$newqry3 = "SELECT * FROM course_enroll WHERE email='".$_SESSION['user']."'";
        $query3=mysqli_query($conn, $newqry3);
        while($row3=mysqli_fetch_array($query3))
		{
			if($query3)
	        {
			 ...
			 <div class="panel-body"> 
		       <a href="c++_course_overview.php" style="color:#000; text-decoration:none;"><div class="col-md-5 col-sm-5">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                           Enrolled Course
                        </div>
                        <div class="panel-body">
                        <p><img src="img/1.png" width="70px"><strong>&nbsp;&nbsp;&nbsp;Programming C++</strong>
						</p>
                        </div>
					...
					<a href="unenroll_process.php?email=<?php echo $row3['email'];?>"><button class="btn btn-danger">Unenroll Course</button></a>
                </div>
			</a>
	       <?php
	       }
