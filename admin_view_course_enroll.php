...
$sql = "SELECT * FROM course_enroll";
 ...
 while($row = mysqli_fetch_array($check))
 {
     ...
     echo "<td><button class=btn2><a href=admin_course_enroll_delete.php?email=".$row['email'].">Delete</button></td>";
	...
	$("body").on("click", "#btnExport", function () {
            html2canvas($('#tblUsers')[0], {
                onrendered: function (canvas) {
                    ...
                    pdfMake.createPdf(docDefinition).download("course_details.pdf");
                }
            });
        });
    </script>
